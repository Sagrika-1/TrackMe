    ...
    public void getL(View view){
        switch (view.getId()){
            case(R.id.current_loc):
                Intent intentCurrent = new Intent(this,Location_new.class);
                startActivity(intentCurrent);
                break;
            case(R.id.earlier_loc):
                Intent intentEarlier = new Intent(this,Location_new.class);
                startActivity(intentEarlier);
                break;
        }
    }
